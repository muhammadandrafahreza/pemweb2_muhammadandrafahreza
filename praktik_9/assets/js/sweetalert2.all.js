...
(function (global, factory) {
  ...
  const handleToastClick = (instance, domCache, dismissWith) => {
    ...
    domCache.popup.onclick = () => {
      const innerParams = privateProps.innerParams.get(instance);if (innerParams && (isAnyButtonShown(innerParams) || innerParams.timer || innerParams.input)) {
        return;
      }

...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
                    ...
                    <form method="post" action="index.php" class="form-horizontal">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="nama" required id="nama" class="form-control" placeholder="Nama">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input autocomplete="off" type="text" name="tgl_lahir" id="tgl_lahir" class="form-control" placeholder="Tanggal Lahir">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="bb" id="bb" required class="form-control" placeholder="Berat Badan">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="tb" id="tb" required class="form-control" placeholder="Tinggi Badan">
                                </div>
                            </div>
            ...
            $person1 = ['kodePasien' => 'P001', 'tanggal' => '10-01-2022', 'nama' => 'Ahmad', 'jk' => 'Laki-laki', 'bb' => 69.8, 'tb' => 169, 'bmi' => 24.7, 'status' => 'Kelebihan Berat Badan'];
            $person2 = ['kodePasien' => 'P002', 'tanggal' => '10-01-2022', 'nama' => 'Rina', 'jk' => 'Perempuan', 'bb' => 55.3, 'tb' => 165, 'bmi' => 20.3, 'status' => 'Normal/Ideal'];
            $person3 = ['kodePasien' => 'P003', 'tanggal' => '11-01-2022', 'nama' => 'Lutfi', 'jk' => 'Laki-laki', 'bb' => 45.2, 'tb' => 171, 'bmi' => 15.4, 'status' => 'Kelebihan Berat Badan'];
            ...
            $all_pasien = [$person1, $person2, $person3, $pasien];
            if (!empty($nama)) {
            ?>
                <div class="card-body" id="hasil">
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Hasil Body Mass Index (BMI)</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
